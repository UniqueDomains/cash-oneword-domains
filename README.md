# Available .CASH One-Word Domains (8,557)
...
**Public extract:** 8,557 rows · **Live catalog:** 8,557 domains
...
- `cash.csv` — public CSV extract (8,557 rows)
- `cash.json` — public JSON extract (8,557 rows)
...
| ----------------------- | ------------------------------------------------ |
| 8,557-row public sample | 8,557 live domains                               |
